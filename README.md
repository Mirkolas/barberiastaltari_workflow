...
- `RUNNER_ENABLED`: imposta esattamente `true` soltanto dopo aver verificato i secret; protegge il backup schedulato durante il passaggio.
...
I workflow non contengono valori sensibili in chiaro. Prima di disattivare i workflow nel repository privato, esegui manualmente deploy, backup e restore in modalita sicura per verificare la configurazione; poi abilita `RUNNER_ENABLED=true`.
